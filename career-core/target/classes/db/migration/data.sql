...
-- personality_tags：Holland RIASEC 人格标签（R实用/I研究/A艺术/S社会/E企业/C常规）
INSERT INTO career_direction (id, direction_code, name, type, status, personality_tags, content) VALUES
    (1, 'DIR001', '软件开发工程师',   '技术研发', 'ACTIVE',   'I,R,C', '从事后端/全栈软件开发，负责业务系统设计与实现。'),
    (2, 'DIR002', '数据科学与算法工程师', '数据算法', 'ACTIVE', 'I,C,R', '面向大数据与机器学习，负责算法设计与模型落地。'),
    (3, 'DIR003', '产品经理',         '产品管理', 'ACTIVE',   'E,S,A', '负责产品规划、需求分析与项目推进。'),
    (4, 'DIR004', '网络安全工程师',   '技术研发', 'ACTIVE',   'I,R,C', '负责系统安全防护、渗透测试与安全运营。'),
    (5, 'DIR005', '游戏开发工程师',   '技术研发', 'ACTIVE',   'A,I,R', '从事游戏客户端/服务端开发与游戏逻辑实现。'),
    (6, 'DIR006', '测试开发工程师',   '技术研发', 'ACTIVE',   'C,I',   '负责自动化测试框架与质量保障体系建设。'),
    (7, 'DIR007', '前端开发工程师',   '技术研发', 'ACTIVE',   'A,I',   '从事 Web 前端界面开发与交互实现。'),
    (8, 'DIR008', '数据分析师',       '数据算法', 'ACTIVE',   'I,C,S', '负责业务数据分析、报表与决策支持。'),
    (9, 'DIR009', '项目管理',         '项目管理', 'INACTIVE', 'E,S,C', '负责项目计划、进度与资源协调管理。')
ON DUPLICATE KEY UPDATE name = VALUES(name), type = VALUES(type), status = VALUES(status),
    personality_tags = VALUES(personality_tags), content = VALUES(content);
