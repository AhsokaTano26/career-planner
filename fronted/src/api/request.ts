...
export const api = {
  ...
  student: {
    ...
    createExploration:(data:{path?:string;answers:{questionId:string;optionIndex:number}[]})=>post<unknown>('/students/me/explorations',data),
    createExplorationProbe:(data:{path?:string;answeredQuestionIds:string[];askedCount:number})=>post<unknown>('/students/me/explorations/probe',data),
