...
const props=defineProps<{ experiences:Experience[]; saving:boolean }>()
const emit=defineEmits<{ save:[draft:ExperienceDraft]; remove:[id:string] }>()
