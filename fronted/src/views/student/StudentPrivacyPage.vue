...
function submit(){const current=action.value;if(current==='password')changePassword(oldPassword.value,newPassword.value);if(current==='delete')requestDeletion(reason.value);action.value=null;oldPassword.value='';newPassword.value='';reason.value=''}
</script>
