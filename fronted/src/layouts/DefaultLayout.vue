...
<template>
  <div class="app-shell">
    ...
    <main class="main-content"><header class="topbar"><span>重庆大学大数据与软件学院 · {{ names[role] }} · 2026—2027 学年第一学期</span><div><button class="logout-btn" @click="handleLogout">↙ 退出登录</button></div></header><section class="page"><Transition name="page" mode="out-in"><RouterView/></Transition></section></main>
  </div>
</template>
